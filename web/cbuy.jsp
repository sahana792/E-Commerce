<%-- 
    Document   : cbuy
    Created on : 29 Sep, 2025, 6:57:21 PM
    Author     : user
--%>
...
<nav>
    ...
    <div class="center-container">
        ...
        <form action="vdetaildb?id=<%=id %>" method="POST">
            <label>Name</label>
            ...
            <label>Quality</label>
            <input type="text" placeholder="Enter quality" value="<%=quality %>" name="quality" required>

            <label>Total</label>
            <input type="text" placeholder="Enter total" value="<%=total %>" name="total" required>
